...
def echo_func(input_1: str):
    print(input_1)

echo_op = kfp.components.func_to_container_op(echo_func)
...
@dsl.pipeline(
    name='Reusable component test',
    description='Sample Kubeflow pipeline with sample reusable component'
)
def calc_pipeline():
    ...
    echo_task = echo_op(
        input_1=dummy1_task.outputs['output_1']
    )
